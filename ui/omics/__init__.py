...
class OmicsUIResourceConfig(CCMMRecordsUIResourceConfig):
    template_folder = "templates"
    url_prefix = "/omics"
    blueprint_name = "omics_ui"
    model_name = "omics"
    search_component = UIComponent(
        "OmicsResultsListItem",
        "@js/omics/search/ResultsListItem",
    ...
    application_id = "omics"


class OmicsUIResource(CCMMRecordsUIResource):
    pass

def ui_overrides(app):
    """Register UI overrides."""
    ui_resource_config = OmicsUIResourceConfig()
...
def create_blueprint(app):
    ...
    blueprint = OmicsUIResource(OmicsUIResourceConfig()).as_blueprint()
    return blueprint
